...
-   Explique a diferença entre autenticação e autorização
    -   [Autenticação versus autorização](https://docs.microsoft.com/pt-br/azure/active-directory/develop/authentication-vs-authorization?WT.mc_id=github-guide-cyzanon)
-   Descrever a funcionalidade e o uso do Azure Active Directory
    -   [Azure AD](https://docs.microsoft.com/pt-br/azure/active-directory/fundamentals/active-directory-whatis?WT.mc_id=github-guide-cyzanon)
